...
struct BioAmpEXGPillUart {
    BioAmpEXGPillApp* app;
...
void bioamp_exg_pill_uart_on_irq_cb(
    FuriHalSerialHandle* handle,
    FuriHalSerialRxEvent event,
    void* context) {
    BioAmpEXGPillUart* uart = (BioAmpEXGPillUart*)context;
...
static int32_t uart_worker(void* context) {
    BioAmpEXGPillUart* uart = (void*)context;
...
BioAmpEXGPillUart* bioamp_exg_pill_uart_init(
    BioAmpEXGPillApp* app,
    FuriHalSerialId channel,
    const char* thread_name) {
    BioAmpEXGPillUart* uart = malloc(sizeof(BioAmpEXGPillUart));
...
BioAmpEXGPillUart* bioamp_exg_pill_usart_init(BioAmpEXGPillApp* app) {
    return bioamp_exg_pill_uart_init(app, UART_CH, "BioAmpEXGPillUartRxThread");
}
